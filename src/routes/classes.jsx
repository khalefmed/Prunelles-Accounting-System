...
function Classes() {
  ...
  return (
    <div className="flex flex-col gap-10 px-10 max-sm:px-4 ">
      ...
      <div>
        <h1 className='font-bold text-2xl text-blackColor '>Classes</h1>
        <p className='text-textGreyColor font-medium'>Page de gestion des classes</p>
      </div>

   
      {liste && <ListeClasses donnees={liste} setDonnees={setListe}/>}
