            ...
            <table className='w-full border-separate border-spacing-y-2'>
                ...
                <tbody className=''>
                    ...
                    <tr key={e.id} className='bg-whiteColor'>
                        <td className={`py-4 px-4 min-w-[200px] text-start text-textGreyColor font-medium text-sm rounded-lg`}>{e.type.nom_type}</td>
                        ...
                        <td className='py-4 min-w-[200px] text-start text-textGreyColor font-medium text-sm '>{e.compte.nom_compte}</td>
                        <td className='py-4 min-w-[100px] text-start text-textGreyColor font-medium text-sm '>{e.date}</td>
